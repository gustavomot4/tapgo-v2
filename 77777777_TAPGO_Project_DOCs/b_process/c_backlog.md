...
- [ ] A-10 — encolher as **questões abertas** do `c_decisions.md`, que é onde sobrou a gordura: `Q-08` tem 613 caracteres, `Q-07` 406, `Q-09` 346 e `QA-04` 416, todas violando o "teto de 2 frases por linha" que o próprio arquivo declara. Mover a justificativa longa para `e_qa/<slug>.md` e deixar a pergunta · **Portão:** registro abaixo de 9.000 com toda linha `Q-NN`/`QA-NN` cabendo em 2 frases, e nenhuma questão saindo de "aberta" no caminho. **Não é arquivamento** — questão aberta não se arquiva, e por isso não coube em `A-09`
