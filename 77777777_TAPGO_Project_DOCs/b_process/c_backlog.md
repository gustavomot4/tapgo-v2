...
- [x] T-17 — sorteio de quem cobra primeiro ✔ backend fechado em… · **Módulo:** M2 · íntegra em [[backlog_archive]]
...
- [x] T-39 — os comentários de `Q-09` citam `D-107` e o gatilho virou portão do CI (fecha `D-107`/`QA-07`) · **Módulo:** M7 (+ o comentário de M5) · íntegra em [[backlog_archive]]
