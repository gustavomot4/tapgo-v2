...
| M5 | Sessão: `cpu`, `local` e `online` | `T-09` + `T-13` (o `online`) |
| M6 | Transporte P2P | `T-11` |
| M7 | Telas (DOM) e a cobrança em Phaser | `T-10` + `T-17b` + `T-20` + `T-14` (as 3 telas do torneio) |
...
**`T-17`** (o sorteio de quem cobra primeiro, `D-48`) está em `cpu` e `local`.
