...
| QA-41 | 2026-08-29 | BAIXO | `README.md` (linha 70), o bloco `scripts/` | O inventário lista `test_check.py` e `new_project.py`, que nunca existiram nesta instalação, e omite `arquivar.py`, `evidencia.py`, `escopo_hook.py` e `portao_hook.py`, que existem | Refazer o bloco pelo conteúdo real de `scripts/`. Achado ao fechar `QA-29` (regra 4) | _(aberto)_ |
