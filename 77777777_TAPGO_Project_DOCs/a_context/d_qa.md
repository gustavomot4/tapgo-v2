...
| QA-39 | 2026-08-29 | MÉDIO | `b_plan.md:349`, `online_p2p.md:107` e o card `T-17` do BACKLOG | Os três tratam `Q-11` como **aberta e travando** o sorteio no `online`; `D-73` a respondeu em 2026-08-19, e o card do PRÓXIMO passo descreve bloqueio que não existe | Reescrever os três por `D-73`: no `online` resta regra de M5, não porta congelada. Achado ao arquivar (regra 4) | _(aberto)_ |
