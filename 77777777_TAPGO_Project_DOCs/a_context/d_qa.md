...
|---|---|---|---|---|---|---|
| QA-07 | 2026-08-08 | BAIXO | `Q-08` e `Q-09`, no próprio registro | Prazo de decisão vencido com a questão ainda aberta: `Q-08` dizia "antes de E-3" (fechada) e `Q-09` "antes de T-10" (feita) | O dono redata o prazo ou responde a questão — `A-10` não mexe em prazo alheio (regra 6) | **PARCIAL 2026-09-01** — a metade de `Q-08` fechou com `D-103`; segue aberto por `Q-09` |
