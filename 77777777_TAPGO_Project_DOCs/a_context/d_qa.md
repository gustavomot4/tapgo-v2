...
| QA-33 | 2026-08-21 | MÉDIO | CONTEXT, linha do Objetivo × `D-73`/`T-21`/`A-22` | O Objetivo ainda diz o online **"medido e não publicado"** (`D-72`), mas a condição que `D-72` pôs foi cumprida: `D-73` fechou `Q-11`, `T-21` entregou a tela de convite e `A-22` a confirmou em dois aparelhos | Depende de saber se o build **no ar** foi republicado depois de `T-21`: virou `A-33` | _(aberto)_ |
