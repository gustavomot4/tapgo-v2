...
|---|---|---|
| Q-01 | Regra exata das alternadas/morte súbita: termina com diferença de 1 em cobranças iguais, ou outra regra? | antes da Fase 2 (é invariante do motor) |
| Q-02 | A CPU adapta ao padrão do jogador ou sorteia 1/3 puro como a v1? Qual o teto de dificuldade? | antes da Fase 2 |
