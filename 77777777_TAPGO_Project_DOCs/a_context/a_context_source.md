...
- **Próximo:** **A-17** — E-5 conferida: 64 disputas, procedência dos 32 SVGs (SHA-256) e `grep` da lista-morta passam; faltam os 2 itens de aparelho: torneio inteiro por toque e reload no meio
