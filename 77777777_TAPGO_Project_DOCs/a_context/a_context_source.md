...
- **Pronto:** M1..M9 e a medição, **E-1..E-6 fechadas**; suíte **665/665**; `T-24`..`T-33` **COM CAMPO** (`A-27`..`A-32`, `A-35`..`A-37`, **`A-39`**), e `T-30`/`T-32`/`T-33` **NO AR** (`A-38`); **`T-31` INTEIRA e CONFIRMADA** (`A-39`: 2 aparelhos); o ar **é `HEAD` em jogo** — `T-34`/`T-36`/`T-37` não mudam um byte de `dist/`, e `T-38` só a de medição (`A-40` exige publicar). Módulo a módulo: [[estado_modulos]]
