...
- **Bloqueado/pendente:** registro **10.998/12.000** (acima do aviso de 9.600 — `A-15`) e QA **6.228/8.000**, folga somada **2.774**; esta sessão comeu 932 · Q-11 trava o online · a bandeira existe mas **não aparece na tela** até M7 (`QA-19`)
