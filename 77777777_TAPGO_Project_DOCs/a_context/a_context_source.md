...
- **Próximo:** **E-6** (entrega) — os 6 critérios de [[portao_de_aceite]] verdes, `check.py --historico-completo` verde e a tabela de [[stack]] fechada (TURN por `D-47`, STUN novo); falta `A-18` e a porta do dono sobre o online
