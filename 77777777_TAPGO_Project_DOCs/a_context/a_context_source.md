...
- **Pronto:** M1..M9 e a medição, **E-1..E-6 fechadas**; suíte **613/613**; `T-24`..`T-30` e `T-32` **COM CAMPO** (`A-27`..`A-32`, `A-35`, `A-36`); `T-33` sem campo (`A-37`); o ar em dia **até `0f231bd`**, amarelo incluído (`A-34`/`A-35`) — `T-32`/`T-33` fora do ar. Módulo a módulo: [[estado_modulos]]
...
- **Próximo:** `A-37` — a bola se separa da linha branca? (`T-33`/`QA-36`, campo) · `T-31` travada em `D-NN` de contrato · portão de `D-83`: **7 de 10**
