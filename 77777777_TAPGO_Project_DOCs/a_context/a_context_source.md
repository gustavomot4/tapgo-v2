...
- **Pronto:** M1..M9 e a medição, **E-1..E-6 fechadas**; suíte **598/598**; `T-24`..`T-29` **COM CAMPO** (`A-27`..`A-32`); **o ar em dia** (`A-34`: 1 listrada no endereço público). Módulo a módulo: [[estado_modulos]]
...
- **Próximo:** `T-32` — contador da série de revanches (M7 só, nenhum contrato de M2/M5 muda) · `T-30` na fila; `T-31` travada em `D-NN` de contrato · portão de `D-83`: **6 de 10**
