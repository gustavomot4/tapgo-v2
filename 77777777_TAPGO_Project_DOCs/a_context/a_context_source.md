...
- **Pronto:** M1..M9 e a medição, **E-1..E-6 fechadas**; suíte **678/678**; `HEAD` está **à frente do ar** (`D-103`/`D-104`).
...
- **Bloqueado/pendente:** publicar `D-103` (o ar ainda é v2.0.0) — `D-97`: registro **17.4k**/20k · BACKLOG **12.3k**/20k · QA **6.5k**/8k; subir teto segue REPROVADO (`D-99`/`D-101`)
