...
- **Pronto:** M1..M9 e a medição, **E-1..E-6 fechadas**; suíte **656/656**; `T-24`..`T-33` **COM CAMPO** (`A-27`..`A-32`, `A-35`..`A-37`, **`A-39`**), e `T-30`/`T-32`/`T-33` **NO AR** (`A-38`); **`T-31` INTEIRA e CONFIRMADA** (`A-39`: 2 aparelhos); o ar **é `HEAD` em jogo** — `T-34`/`T-36`/`T-37` não mudam um byte de `dist/`. Módulo a módulo: [[estado_modulos]]
...
- **Bloqueado/pendente:** registro **18.7k/20.000** — aviso voltou em `D-92`; subir o teto segue REPROVADO · **CONTEXT: 17 de folga, o menor** · QA **7.3k/8.000** · `D-75`/`D-76` isentas
- **Questões abertas:** Q-08, Q-09, Q-13 (**Q-15/Q-16 fechadas** por `D-84`/`D-88`) · **QA abertos:** QA-07, QA-10, QA-17, QA-27, QA-29, QA-34, QA-35 (**QA-04/QA-05/QA-06/QA-21/QA-32/QA-33/QA-36 fechados**) (**QA-20 fechado** por `T-29`) · respondidas e fechados: [[decisions_archive]]
