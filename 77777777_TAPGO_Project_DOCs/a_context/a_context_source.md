...
- **Próximo:** **A-08 com APN forçado a IPv4 nos dois aparelhos** (`D-46`) — 1ª medição do caminho COM NAT; os 13/13 de hoje foram todos por IPv6, onde NAT não existe. O corte de 70% cobra só o contador IPv4
- **Bloqueado/pendente:** A-04 trava E-5 e a lista real de M4 (hoje fixação, `flag: null` — D-22) · A-06 trava M8 · Q-11 trava a tela do online · registro a **11.327/12.000** — **673 até a FALHA, `A-13` trava a próxima sessão**
- **Questões abertas:** Q-03, Q-05, Q-07..**Q-11** · Q-04→D-35, Q-12→D-46 · **QA abertos:** QA-04..QA-07, QA-10 · QA-13 fecha na próxima ida · **QA-11 sem objeto** · fechados: QA-08, QA-09, QA-12, QA-14
