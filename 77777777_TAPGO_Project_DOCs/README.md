...
| Projeto longo (100+ decisões) | Com atrito | o teto de 20.000 chars do [[c_decisions|DECISIONS]] (`D-82`) dá ~45 linhas ao custo medido de 438 cada, ou ~57 com o teto de 400 por linha de `D-83` valendo; o arquivamento em `e_qa/decisions_archive.md` é **manual**, e neste projeto ele **acabou** — nenhuma linha viva deixou de ser citada |
